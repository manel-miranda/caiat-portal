...
function FinancePage() {
  ...
  const summary = {
    ...
    purchaseSpendPrevious30d:
      report.data?.summary?.purchaseSpendPrevious30d ?? 0,
  ...
  const averageMargin = known.length
    ? known.reduce((sum, dish) => sum + Number(dish.marginPercent), 0) /
      known.length
    : null;
  const spendChange =
        ...
        <>
          ...
          <FinanceSection title={t("financePurchasing")}>
            ...
            <StatCard
              ...
              tone={
                spendChange != null && spendChange > 0 ? "warning" : "default"
              }
            />
          </FinanceSection>
          ...
          <FinanceSection title={t("financeProfitability")}>
            ...
            <StatCard
              ...
              tone={
                dishes.some((dish) => dish.missingCost) ? "warning" : "success"
              }
            />
          </FinanceSection>
                  ...
                  <div key={dish.id} className="px-4 py-3">
                    ...
                    {dish.missingCost ? (
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-x-4 gap-y-2 sm:grid-cols-4">
                        <Metric
                          label={t("financeSellingPrice")}
                          value={mad(dish.price)}
                        />
                        <Metric
                          label={t("financeFoodCost")}
                          value={mad(dish.cost ?? 0)}
                        />
                        <Metric
