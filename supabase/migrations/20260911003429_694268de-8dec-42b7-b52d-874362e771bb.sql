...
ALTER TABLE public.charges ADD CONSTRAINT charges_quantity_positive CHECK (quantity > 0);
ALTER TABLE public.charges ADD CONSTRAINT charges_unit_price_non_negative CHECK (unit_price >= 0);
ALTER TABLE public.cash_reconciliations ADD CONSTRAINT cash_counted_non_negative CHECK (counted_total >= 0);